...
# Copy the current directory contents into the container at /app
ADD target/RestAPI-0.0.1-SNAPSHOT.jar restapi-microservice.jar
...
ENTRYPOINT [ "sh", "-c", "java $JAVA_OPTS -Djava.security.egd=file:/dev/./urandom -jar restapi-microservice.jar" ]